...
_SCRIPT_URL = (
    ...
    '/refs/heads/main/dags/clickhouse/load-encode-logs.py'
)
...
def load_encode_logs_to_clickhouse():
    KubernetesPodOperator(
        task_id='load-encode-logs-to-clickhouse',
...
load_encode_logs_to_clickhouse()
